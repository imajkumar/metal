$(function(){
  var tickerLength = $('.container_aj ul li').length;
  var tickerHeight = $('.container_aj ul li').outerHeight();
  $('.container_aj ul li:last-child').prependTo('.container_aj ul');
  $('.container_aj ul').css('marginTop',-tickerHeight);
  function moveTop(){
    $('.container_aj ul').animate({
      top : -tickerHeight
    },600, function(){
     $('.container_aj ul li:first-child').appendTo('.container_aj ul');
      $('.container_aj ul').css('top','');
    });
   }
